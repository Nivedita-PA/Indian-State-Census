...
public class IndianStateCensus5 {

    public int loadCensusData5(String FILE_PATH) throws CensusAnalyserException {
        ...
        try (Reader reader = Files.newBufferedReader(Paths.get(FILE_PATH));) {
            ...
            throw new CensusAnalyserException(ex.getMessage(), CensusAnalyserException.ExceptionType.INCORRECT_HEADER);
        }
